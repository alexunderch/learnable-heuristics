...
python3 generate_oracles_xy.py --database_folders ${TRAIN_FOLDER_1} --num_envs 2 --file_start_num 0 --file_type ${FILE_TYPE}
python3 generate_oracles_xy.py --database_folders ${VALID_FOLDER_1} --num_envs 2 --file_start_num 800 --file_type ${FILE_TYPE}
